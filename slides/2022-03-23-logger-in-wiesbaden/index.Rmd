---
title: "R Coffee Break<br />logger - A Modern Logging Utility<br/>"
subtitle: "Wiesbaden R User Group"
...
<section data-background-image="img/wiesbaden-r-meetup-transparent.jpeg"
         data-background-size="100%"
         id="coverslide">

<h1 class="subtitle" style="color:#eee;font-size:2em;-webkit-text-stroke-width: 1px;-webkit-text-stroke-color: rgba(0, 0, 0, 1);">
  Wiesbaden R User Group
</h1>

<h1 class="title" style="color:#eee;font-size:2.25em;padding-top:10%;-webkit-text-stroke-width: 1px;-webkit-text-stroke-color: rgba(0, 0, 0, 1);">
  R Coffee Break:<br />logger - A Modern Logging Utility<br/>
</h1>

<h2 class="author" style="color:#eee;padding-top:7%;font-size:1.5em;margin-left: 35rem;-webkit-text-stroke-width: 1px;-webkit-text-stroke-color: rgba(0, 0, 0, 1);">
  Gergely Daróczi
</h2>

<h3 class="date" style="color:#eee;font-size:1.25em;margin-left: 35rem;-webkit-text-stroke-width: 1px;-webkit-text-stroke-color: rgba(0, 0, 0, 1);">
  @daroczig
</h3>
...
* Job output is informative (<b>logging</b>), recorded (<b>logging</b>) and monitored (e.g. `error` handler for ErrBit, CloudWatch logs or Splunk etc), alerts and notifications
...
* `appender_stdout`
* `appender_file` (with basic log rotating)
* `appender_tee`

<div class="fragment" style="text-align: left;padding-top: 20px;">
* `appender_slack`
* `appender_telegram`
* `appender_pushbullet`
</div>
...
## > do.call(..., logger) {data-transition="none"}
...
## > help(package = logger) {data-transition="slide-in none-out"}
...
## > help(package = logger) {data-transition="none"}
