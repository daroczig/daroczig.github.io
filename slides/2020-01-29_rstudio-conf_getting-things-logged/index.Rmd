...
* the output of the jobs are recorded and <b>monitored</b> (eg `error` handler for ErrBit, CloudWatch logs or Splunk etc)
...
<img src="img/logger_structure.png" width="90%" class="noborder" />
...
<a href="https://thecodinglove.com/when-i-desperatly-search-in-the-logs-why-the-app" 
   target="_new" class="fragment" data-fragment-index="1">
  <video width="75%" controls autoplay muted loop>
