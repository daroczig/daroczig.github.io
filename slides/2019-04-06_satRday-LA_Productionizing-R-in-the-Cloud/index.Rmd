...
<img src="https://github.com/jennybc/code-smells-and-feels/raw/master/2018-07_user-brisbane-400.jpeg" />

*Code Smells and Feels* by Jenny Bryan
</div>

<div style="float:left; width:50%;">
<img src="img/book advanced r.png" />
...
<div style="float:left; width:50%;">
<img src="img/book clean code.jpg" />

*Clean Code* by Robert C. Martin
</div>

<div style="float:left; width:50%;">
<img src="img/book refactoring.jpg" />
...
library(jsonlite)
s3_write(mtcars, 's3://botor/example-data/mtcars.RDS', writeJSON, compress = 'gzip')
```
